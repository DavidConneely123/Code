...
class Nucleus:
    ...
    def Ix(self):
        return scipy.sparse.kron(i4, scipy.sparse.kron(scipy.sparse.identity(self.nuclear_dimensions_before(), format = 'coo') , scipy.sparse.kron( self.sx() , scipy.identity(self.nuclear_dimensions_after()))))

    def Iy(self):
        return scipy.sparse.kron(i4, scipy.sparse.kron(scipy.sparse.identity(self.nuclear_dimensions_before(), format = 'coo') ,scipy.sparse.kron(self.sy(), scipy.identity(self.nuclear_dimensions_after()))))

    def Iz(self):
        return scipy.sparse.kron(i4, scipy.sparse.kron(scipy.sparse.identity(self.nuclear_dimensions_before(), format = 'coo') ,scipy.sparse.kron(self.sz(), scipy.identity(self.nuclear_dimensions_after()))))
...
def Iterating_Over_Selections_of_13C():
    x1 =[]
    y1 =[]
    ...
    while iteration_counter < 100:
        ...
        random_list = random.sample(range(len(Nucleus.isotopologues)) ,  len(Nucleus.isotopologues) - 4)  # Choose the N-7 13C to remove from the simulation
...
def Iterating_Over_Selections_All_Nuclei(number_of_iterations, number_of_nuclei):
    x1 =[]
    y1 =[]
...
Iterating_Over_Selections_All_Nuclei(100, 10)
