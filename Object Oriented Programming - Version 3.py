...
class Nucleus:
    ...
    def SAxIix(self):
        return scipy.sparse.kron(sx_spinhalf, scipy.sparse.kron(i2, scipy.sparse.kron(np.identity(self.nuclear_dimensions_before()), scipy.sparse.kron(self.sx(), np.identity(self.nuclear_dimensions_after()), format='csr'),format='csr'),format='csr'),format='csr')

    def SAxIiy(self):
        return scipy.sparse.kron(sx_spinhalf, scipy.sparse.kron(i2, scipy.sparse.kron(np.identity(self.nuclear_dimensions_before()), scipy.sparse.kron(self.sy(), np.identity(self.nuclear_dimensions_after()), format='csr'),format='csr'),format='csr'),format='csr')

    def SAxIiz(self):
        return scipy.sparse.kron(sx_spinhalf, scipy.sparse.kron(i2, scipy.sparse.kron(np.identity(self.nuclear_dimensions_before()), scipy.sparse.kron(self.sz(), np.identity(self.nuclear_dimensions_after()), format='csr'),format='csr'),format='csr'),format='csr')

    def SAyIix(self):
        return scipy.sparse.kron(sy_spinhalf, scipy.sparse.kron(i2, scipy.sparse.kron(np.identity(self.nuclear_dimensions_before()), scipy.sparse.kron(self.sx(), np.identity(self.nuclear_dimensions_after()), format='csr'),format='csr'),format='csr'),format='csr')

    def SAyIiy(self):
        return scipy.sparse.kron(sy_spinhalf, scipy.sparse.kron(i2, scipy.sparse.kron(np.identity(self.nuclear_dimensions_before()), scipy.sparse.kron(self.sy(), np.identity(self.nuclear_dimensions_after()), format='csr'),format='csr'),format='csr'),format='csr')

    def SAyIiz(self):
        return scipy.sparse.kron(sy_spinhalf, scipy.sparse.kron(i2, scipy.sparse.kron(np.identity(self.nuclear_dimensions_before()), scipy.sparse.kron(self.sz(), np.identity(self.nuclear_dimensions_after()), format='csr'),format='csr'),format='csr'),format='csr')

    def SAzIix(self):
        return scipy.sparse.kron(sz_spinhalf, scipy.sparse.kron(i2, scipy.sparse.kron(np.identity(self.nuclear_dimensions_before()), scipy.sparse.kron(self.sx(), np.identity(self.nuclear_dimensions_after()), format='csr'),format='csr'),format='csr'),format='csr')

    def SAzIiy(self):
        return scipy.sparse.kron(sz_spinhalf, scipy.sparse.kron(i2, scipy.sparse.kron(np.identity(self.nuclear_dimensions_before()), scipy.sparse.kron(self.sy(), np.identity(self.nuclear_dimensions_after()), format='csr'),format='csr'),format='csr'),format='csr')
...
Hamiltonian = H_hyperfine() + H_zee(0.05,0,0)

valmax=scipy.sparse.linalg.eigsh(Hamiltonian, k=1, M=None, sigma=None, which='LA', v0=None, ncv=None, maxiter=None, tol=0, return_eigenvectors=False, Minv=None, OPinv=None)
valmin=scipy.sparse.linalg.eigsh(Hamiltonian, k=1, M=None, sigma=None, which='SA', v0=None, ncv=None, maxiter=None, tol=0, return_eigenvectors=False, Minv=None, OPinv=None)
Vmax = valmax - valmin
Vmax = Vmax[0]/1e6
